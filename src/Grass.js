...
// Extend the React Three Fiber library with the Geometry class
extend({ Geometry });
...
export default function Grass({ options = { bW: 0.12, bH: 0.9, joints: 2 }, width = 500, instances = 2500000, ...props }) {
  ...
  const groundGeo = useMemo(() => {
    ...
    //const geo = new BufferGeometry().fromBufferGeometry(new THREE.PlaneGeometry(width, width, 32, 32))
